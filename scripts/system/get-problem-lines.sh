#!/bin/bash
# Получение проблемных строк из event-logger.js
set -e
...
echo "Получение строк 630-680..."
run_on_pi "cd $PROJECT_DIR && sed -n '630,680p' event-logger.js" > "$PROJECT_ROOT/problem-lines.txt"
echo "Сохранено в problem-lines.txt"
